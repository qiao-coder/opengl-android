 ...
 * @date 2022/4/29.
 */
public class RedTriangleRender extends TriangleRender {
    ...
    public RedTriangleRender(Context context) {
        super(context);
    }

    @Override
    protected int getVertexShaderCode() {
        return R.raw.vertex_triangle_red;
    }

    @Override
    protected int getFragShaderCode() {
        return R.raw.frag_triangle_red;
    }
