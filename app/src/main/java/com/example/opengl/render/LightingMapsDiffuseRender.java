 ...
 * @date 2022/6/27.
 */
public class LightingMapsDiffuseRender extends BaseRender {
    ...
    public LightingMapsDiffuseRender(Context context) {
        super(context);
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        lightingShader = new Shader.Builder(context)
                .setVertexShader(R.raw.vertex_lighting_maps_diffuse)
                .setFragShader(R.raw.frag_lighting_maps_diffuse)
                .build();
