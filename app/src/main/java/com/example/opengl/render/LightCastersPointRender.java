 ...
 * @date 2022/6/29.
 */
public class LightCastersPointRender extends BaseRender {
    ...
    public LightCastersPointRender(Context context) {
        super(context);
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        lightingShader = new Shader.Builder(context)
                .setVertexShader(R.raw.vertex_light_casters_point)
                .setFragShader(R.raw.frag_light_casters_point)
                .build();
