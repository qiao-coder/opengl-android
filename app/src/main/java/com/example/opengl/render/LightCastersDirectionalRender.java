 ...
 * @date 2022/6/27.
 */
public class LightCastersDirectionalRender extends BaseRender {
    ...
    public LightCastersDirectionalRender(Context context) {
        super(context);
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        lightingShader = new Shader.Builder(context)
                .setVertexShader(R.raw.vertex_light_casters_directional)
                .setFragShader(R.raw.frag_light_casters_directional)
                .build();
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        //当我们只有一束方向光的时候，灯对象是很奇怪的，不要渲染光对象
//        lightCubeShader.use();
