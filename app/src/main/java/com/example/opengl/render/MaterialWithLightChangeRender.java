 ...
 * @date 2022/6/16.
 */
public class MaterialWithLightChangeRender extends BaseRender {
    ...
    public MaterialWithLightChangeRender(Context context) {
        super(context);
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        lightingShader = new Shader.Builder(context)
                ...
                .setFragShader(R.raw.frag_material_with_light_change)
                .build();
...
//        lightingShader.setVec3("objectColor", 1.0f, 0.5f, 0.31f);
        ...
        //光属性
        //不再使用简单的光照颜色等，改用通过light设置各个光照分量、光源位置
